...
#define CMD_RESET 0x18 // ctrl-x.  also '&' works -- LDO
...
#define SPINDLE_MIN_RPM 2400.0    // Min spindle RPM. This value is equal to (1/256) duty cycle on the PWM.
...
#define MINIMUM_SPINDLE_PWM 0 // Default disabled. Uncomment to enable. Integer (0-255)
