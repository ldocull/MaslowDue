...
//            #ifdef MASLOWCNC
//              if (idx == LEFT_MOTOR) {
//                int32_t axis_position = system_convert_maslow_to_x_axis_steps(sys.position);
//                sys.position[LEFT_MOTOR] = axis_position;
//              } else if (idx == RIGHT_MOTOR) {
//                int32_t axis_position = system_convert_maslow_to_y_axis_steps(sys.position);
//                sys.position[RIGHT_MOTOR] = axis_position;
//              } else { 
//                sys.position[idx] = 0; 
//              }
//            #else
    ...
    if (cycle_mask & bit(idx)) {
        ...
        if (idx==X_AXIS) { 
          ...
          sys.position[idx] = set_axis_position;
             ...
             sys.position[LEFT_MOTOR] = (int32_t) lround(aCl * settings.steps_per_mm[LEFT_MOTOR]);
             sys.position[RIGHT_MOTOR] = (int32_t) lround(bCl * settings.steps_per_mm[RIGHT_MOTOR]);
             sys.position[Z_AXIS] = set_axis_position;
             idx = N_AXIS + 1; // force out of loop..
